...
import com.yunmayi.app.baselibrary.utils.TextUtils;
...
public class ItemTextView extends LinearLayout {
	...
	public ItemTextView(Context context, AttributeSet attrs) {
		...
		labelTextColor = array.getColor(R.styleable.ItemTextView_mLabelTextColor, ContextCompat.getColor(context,R.color.text_color_5));
		hintTextColor  = array.getColor(R.styleable.ItemTextView_mHintTextColor, ContextCompat.getColor(context,R.color.text_color_1));
	...
	private void initView(Context context, AttributeSet attrs){
		...
		mlblName = this.findViewById(R.id.mlblName);
		lblVal = this.findViewById(R.id.lblVal);
	...
	public void initLabel(String label, String hit) {
		mlblName.setText(TextUtils.isEmpty(label) ? "" : label);
	...
	public void initData(String dataLabel, String val) {
		this.currVal= TextUtils.isEmpty(val) ? "" : val;
		lblVal.setText(TextUtils.isEmpty(dataLabel) ? "" : dataLabel);
	}
