...
public class SelectCouponWindow extends PopupWindow {
    ...
    public SelectCouponWindow(Context mContext) {
        mView = LayoutInflater.from(mContext).inflate(R.layout.select_coupon_window, null);
